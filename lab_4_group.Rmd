...
bptest(model_3)
```
The Breusch-Pagan test is significant at any level so we can reject the null hypothesis of constant variance. While the low p-value may be due to the large sample size, the level of significance indicates that we should use the heteroskedasticity-robust Huber-White standard errors.
