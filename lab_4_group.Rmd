...
4. Use of 'fmaps' as an independent variable is not appropriate, since it is measured after birth.  It has both high statistical and high practical significance in the model, which will be discussed later.  This combination of results might lead a research to believe it is an important variable, but in the real world, it makes no sense to predict birth weight with a metric taken after birth.
