...
plot(by(mage_exp$birthweight,mage_exp$agebin, mean), main = "Birthweight vs. Mother's age", xaxt = "n",pch = 16, col = "blue")
...
par(mar=c(2,2,10,10))
plot(by(sample$bwght, sample$visitsbin, mean), xaxt ="n", yaxt ="n", xlab ="", ylab ="", pch = 16, col ="blue")
axis(1,axis(1, at =seq(1,5,1), labels = c("0-20","20-40","40-60","60-80","80-100"),xlab = "Percentile of prenatal visits", ylab ="Infant birthweight") )
```
