...
3. Adding two indicator variables for low birthweights is problematic for two reasons: 
  ...
  + Including these terms makes it more difficult for the model to increase the predictive power but also to have any causal interpretation because we know that low birthweight does not cause lower levels of birthweight. 
